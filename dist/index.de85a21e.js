...
*/ (function($) {
    ...
    $.fn.verticalTimeline = function(options) {
        ...
        return this.each(function() {
            ...
            if (!settings.alternate) $(this).find(".vtimeline-block").addClass("vtimeline-" + settings.startSide);
            else if (settings.startLeft) $(this).find(".vtimeline-point:odd").each(function() {
                $(this).find(".vtimeline-block").addClass("vtimeline-right");
            });
            else $(this).find(".vtimeline-point:even").each(function() {
                $(this).find(".vtimeline-block").addClass("vtimeline-right");
            });
            // Add animation style if provided
            if (settings.animate) $(this).find(".vtimeline-block").each(function() {
                var _this = this;
                $(this).addClass("vt-animate-" + settings.animate);
                if (inViewport($(this))) $(this).removeClass("vt-animate-" + settings.animate);
                $(window).on("scroll", function() {
                    if (inViewport($(_this))) $(_this).removeClass("vt-animate-" + settings.animate);
                });
            });
            ...
            $(this).find(".vtimeline-content").each(function() {
                ...
                if (date) $(this).parent().prepend('<span class="vtimeline-date">' + date + "</span>");
            ...
            if (!settings.arrows) $(this).find(".vtimeline-block").addClass("vt-noarrows");
        });
    };
})(jQuery);

//# sourceMappingURL=index.de85a21e.js.map
